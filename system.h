...
//    bool metropolisStep             (unsigned gen);
    ...
    void runMetropolisSteps         (std::vector<int> numberOfMetropolisSteps, bool bruteForce);
...
//    int getNumberOfMetropolisSteps()    { return m_numberOfMetropolisSteps; }
    ...
    int getnStepsIndex()                {return m_nStepIndex;}
    ...
    double getAcceptanceRatio()         {return m_acceptedSteps_ratio;}
    ...
    std::vector<int> getNumberOfMetropolisSteps()    { return m_numberOfMetropolisSteps; }
