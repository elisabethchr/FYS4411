...
public:
    ...
    //This is a pure virtual function, meaning any derived classes e.g. HarmonicOscillator MUST overwrite it.
    ...
    //making sure every derived class has it's own implementation of the function.
